...
urlpatterns = [
    ...
    path("become_expert/",BecomeExpertView.as_view(),name="user_plan_selection"),
    path("user_report/",UserReporterGenrator.as_view(),name="user_report"),
    path("questions/",TestView.as_view(),name="questions"),
