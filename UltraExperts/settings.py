...
DEBUG = DEBUG
#ALLOWED_HOSTS = ["*"]
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '.ngrok.io','UltraExperts.herokuapp.com','ultraxpert-front.herokuapp.com','ultraxpert.com','ultra-env.ap-south-1.elasticbeanstalk.com']
